...
<div class="row">
  ...
  <div class="col-md-4 mb-3">
    ...
    <input type="text" class="form-control @error('nomor_kartu_kredit') is-invalid @enderror" id="nomor_kartu_kredit" name="nomor_kartu_kredit"
      value="{{ old('nomor_kartu_kredit', $transaksi->nomor_kartu_kredit ?? '') }}">
    @error('nomor_kartu_kredit')
      <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  </div>
  ...
  <div class="col-md-4 mb-3">
    ...
    <input type="month" class="form-control @error('masa_berlaku_kartu') is-invalid @enderror" id="masa_berlaku_kartu" name="masa_berlaku_kartu"
      value="{{ old('masa_berlaku_kartu', $transaksi->masa_berlaku_kartu ?? '') }}">
    @error('masa_berlaku_kartu')
      <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-3 mb-3">
    ...
    <input type="number" step="0.01" id="ppn_nominal" name="ppn_nominal"
           ...
           class="form-control d-none @error('ppn_nominal') is-invalid @enderror" readonly>
