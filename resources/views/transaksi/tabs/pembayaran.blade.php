...
<div class="row">
  ...
  <div class="col-md-4 mb-3">
    <label for="nomor_kartu_kredit" class="form-label">No Kartu Kredit</label>
  ...
  <div class="col-md-4 mb-3">
    <label for="masa_berlaku_kartu" class="form-label">Masa Berlaku Kartu</label>
...
<div class="row">
  ...
  <div class="col-md-3 mb-3">
    <label for="biaya_paket_internet" class="form-label">Biaya Paket Internet</label>
 ...
 <div class="col-md-3 mb-3">
     <label for="ppn_nominal" class="form-label">PPN (10%)</label>
...
<div class="row">
 <div class="col-md-3 mb-3">
    <label for="total_biaya_per_bulan" class="form-label">Total Biaya Per Bulan</label>
