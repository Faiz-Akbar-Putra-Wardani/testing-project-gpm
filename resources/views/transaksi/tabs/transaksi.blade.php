...
<div class="row">
  ...
  <div class="col-md-3 mb-3">
    ...
    <input type="text" class="form-control @error('no_id_pelanggan') is-invalid @enderror"
      id="no_id_pelanggan" name="no_id_pelanggan"
  ...
  <div class="col-md-3 mb-3">
    ...
    <select class="form-select @error('paket_internet_id') is-invalid @enderror"
      id="paket_internet_id" name="paket_internet_id" required>
    ...
    <input type="text" class="form-control mt-2 @error('nama_paket') is-invalid @enderror"
    ...
    <input type="number" class="form-control mt-2 @error('harga_bulanan') is-invalid @enderror"
      id="harga_bulanan" name="harga_bulanan"
  ...
  <div class="col-md-3 mb-3">
    ...
    <select class="form-select @error('promosi_id') is-invalid @enderror"
      id="promosi_id" name="promosi_id">
...
<div class="row">
  <div class="col-md-3 mb-3">
    ...
    <input type="text" class="form-control mt-2 @error('nilai') is-invalid @enderror"
      id="nilai" name="nilai"
  ...
  <div class="col-md-3 mb-3">
    ...
    <select class="form-select @error('metode_billing') is-invalid @enderror"
      id="metode_billing" name="metode_billing">
  ...
  <div class="col-md-3 mb-3">
    ...
    <textarea class="form-control @error('alamat_penagihan') is-invalid @enderror"
      id="alamat_penagihan" name="alamat_penagihan" rows="2">{{ old('alamat_penagihan', $transaksi->alamat_penagihan ?? '') }}</textarea>
